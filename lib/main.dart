...
class _OnHazirlikEkraniState extends State<OnHazirlikEkrani>
  ...
  Widget _pulseKiyasSekmesi() {
    ...
    for (final k in tumKalemler) {
      ...
      final myDomVal = k['myDomVal'] as double;
      final isPosOrYemek =
                  ...
                  return Column(
                    children: [
                      ...
                      TabBar(
                        ...
                        tabs: const [
                          Tab(text: 'POS & Kart'),
                          Tab(text: 'Pulse / My Dominos'),
                          Tab(text: 'Şube Kasa'),
                          Tab(text: 'Ana Kasa'),
                          Tab(text: 'Transfer / Diğer Alım'),
                          Tab(text: 'Özet & Kapat'),
                        ],
                      ),
                      Expanded(
                                ...
                                children: [
                                  ...
                                  if (_gunuKapatildi && !_duzenlemeAcik)
                                      ...
                                      child: OutlinedButton.icon(
                                        onPressed: () async {
                                          ...
                                          if (hakki >= 0) {
                                            ...
                                            final referans = _sonKapaliTarih ??
                                                _bugunuHesapla();
                                            final fark = referans
                                                .difference(
                                                  DateTime(
                                    ...
                                    Builder(
                                      builder: (ctx) {
                                        final islemsiz =
                                            _transferler.where((t) {
                                          final kategori =
                                              t['kategori'] as String;
                                          final tutar = _parseDouble(
                                            (t['tutarCtrl']
                                                    as TextEditingController)
                                                .text,
